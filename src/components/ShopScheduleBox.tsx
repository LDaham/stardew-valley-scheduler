...
import { ShopBody, PinButton, type Scenario } from "@/components/ShopScheduleDialog";
...
// - 각 카드는 내용 너비만큼만 차지하고(빈 공간 없음) 좌→우로 채운다. 핀 버튼으로 메인에서도 고정 해제 가능.
export default function ShopScheduleBox() {
  const t = useTranslations();
  const { shopScheduleShown, dialogFilters, setDialogFilters } = useSchedule();
